(function () {
    ...
    angular
        .module('app.maxes')
        .controller('MaxesCtrl', MaxesCtrl);
    MaxesCtrl.$inject = ['$scope', '$state', '$q', '$ionicHistory', '$ionicPopup', 'dataservice', 'wodservice'];
    function MaxesCtrl($scope, $state, $q, $ionicHistory, $ionicPopup, dataservice, wodservice) {
        var vm = this;
