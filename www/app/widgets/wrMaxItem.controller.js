(function () {
    ...
    angular
        .module('app.widgets')
        .controller('MaxItemCtrl', MaxItemCtrl);
    MaxItemCtrl.$inject = ['$scope', '$state', '$ionicActionSheet', '$ionicPopup', 'dataservice', 'WODconstants'];
    function MaxItemCtrl($scope, $state, $ionicActionSheet, $ionicPopup, dataservice, WODconstants) {
        var vm = this;
        vm.itemClass = '';
        vm.itemDate = '';
        vm.footer = '';
